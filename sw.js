...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-9a02b8","is-html-9a02b8","is-jsdelivr-9a02b8","is-gtm-9a02b8","is-gravatar-9a02b8","is-theme-9a02b8","is-cdn-9a02b8","is-json-9a02b8"];
      return Promise.all(
        names
