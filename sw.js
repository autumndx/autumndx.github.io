...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-f08010","is-html-f08010","is-jsdelivr-f08010","is-gtm-f08010","is-gravatar-f08010","is-theme-f08010","is-cdn-f08010","is-json-f08010"];
      return Promise.all(
        names
