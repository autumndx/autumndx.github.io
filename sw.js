...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-e0f339","is-html-e0f339","is-jsdelivr-e0f339","is-gtm-e0f339","is-gravatar-e0f339","is-theme-e0f339","is-cdn-e0f339","is-json-e0f339"];
      return Promise.all(
        names
