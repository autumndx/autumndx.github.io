...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-ebef03","is-html-ebef03","is-jsdelivr-ebef03","is-gtm-ebef03","is-gravatar-ebef03","is-theme-ebef03","is-cdn-ebef03","is-json-ebef03"];
      return Promise.all(
        names
