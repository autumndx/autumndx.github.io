...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-4b82ee","is-html-4b82ee","is-jsdelivr-4b82ee","is-gtm-4b82ee","is-gravatar-4b82ee","is-theme-4b82ee","is-cdn-4b82ee","is-json-4b82ee"];
      return Promise.all(
        names
