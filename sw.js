...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-ca3e7d","is-html-ca3e7d","is-jsdelivr-ca3e7d","is-gtm-ca3e7d","is-gravatar-ca3e7d","is-theme-ca3e7d","is-cdn-ca3e7d","is-json-ca3e7d"];
      return Promise.all(
        names
