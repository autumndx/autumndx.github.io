...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-dee1d0","is-html-dee1d0","is-jsdelivr-dee1d0","is-gtm-dee1d0","is-gravatar-dee1d0","is-theme-dee1d0","is-cdn-dee1d0","is-json-dee1d0"];
      return Promise.all(
        names
