...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-79bf03","is-html-79bf03","is-jsdelivr-79bf03","is-gtm-79bf03","is-gravatar-79bf03","is-theme-79bf03","is-cdn-79bf03","is-json-79bf03"];
      return Promise.all(
        names
