...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-b0e584","is-html-b0e584","is-jsdelivr-b0e584","is-gtm-b0e584","is-gravatar-b0e584","is-theme-b0e584","is-cdn-b0e584","is-json-b0e584"];
      return Promise.all(
        names
