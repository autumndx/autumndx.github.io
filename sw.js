...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-3937d9","is-html-3937d9","is-jsdelivr-3937d9","is-gtm-3937d9","is-gravatar-3937d9","is-theme-3937d9","is-cdn-3937d9","is-json-3937d9"];
      return Promise.all(
        names
