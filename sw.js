...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-e01eab","is-html-e01eab","is-jsdelivr-e01eab","is-gtm-e01eab","is-gravatar-e01eab","is-theme-e01eab","is-cdn-e01eab","is-json-e01eab"];
      return Promise.all(
        names
