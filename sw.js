...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-f31cba","is-html-f31cba","is-jsdelivr-f31cba","is-gtm-f31cba","is-gravatar-f31cba","is-theme-f31cba","is-cdn-f31cba","is-json-f31cba"];
      return Promise.all(
        names
