...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-db0aa0","is-html-db0aa0","is-jsdelivr-db0aa0","is-gtm-db0aa0","is-gravatar-db0aa0","is-theme-db0aa0","is-cdn-db0aa0","is-json-db0aa0"];
      return Promise.all(
        names
