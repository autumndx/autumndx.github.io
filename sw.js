...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-6925c1","is-html-6925c1","is-jsdelivr-6925c1","is-gtm-6925c1","is-gravatar-6925c1","is-theme-6925c1","is-cdn-6925c1","is-json-6925c1"];
      return Promise.all(
        names
