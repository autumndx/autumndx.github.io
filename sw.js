...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-a790a8","is-html-a790a8","is-jsdelivr-a790a8","is-gtm-a790a8","is-gravatar-a790a8","is-theme-a790a8","is-cdn-a790a8","is-json-a790a8"];
      return Promise.all(
        names
