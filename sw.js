...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-cbc123","is-html-cbc123","is-jsdelivr-cbc123","is-gtm-cbc123","is-gravatar-cbc123","is-theme-cbc123","is-cdn-cbc123","is-json-cbc123"];
      return Promise.all(
        names
