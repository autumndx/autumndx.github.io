...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-7a2ea9","is-html-7a2ea9","is-jsdelivr-7a2ea9","is-gtm-7a2ea9","is-gravatar-7a2ea9","is-theme-7a2ea9","is-cdn-7a2ea9","is-json-7a2ea9"];
      return Promise.all(
        names
