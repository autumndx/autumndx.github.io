...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-e6def5","is-html-e6def5","is-jsdelivr-e6def5","is-gtm-e6def5","is-gravatar-e6def5","is-theme-e6def5","is-cdn-e6def5","is-json-e6def5"];
      return Promise.all(
        names
