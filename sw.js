...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-4c0dd2","is-html-4c0dd2","is-jsdelivr-4c0dd2","is-gtm-4c0dd2","is-gravatar-4c0dd2","is-theme-4c0dd2","is-cdn-4c0dd2","is-json-4c0dd2"];
      return Promise.all(
        names
