...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-9f72cf","is-html-9f72cf","is-jsdelivr-9f72cf","is-gtm-9f72cf","is-gravatar-9f72cf","is-theme-9f72cf","is-cdn-9f72cf","is-json-9f72cf"];
      return Promise.all(
        names
