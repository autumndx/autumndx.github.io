...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-e38b77","is-html-e38b77","is-jsdelivr-e38b77","is-gtm-e38b77","is-gravatar-e38b77","is-theme-e38b77","is-cdn-e38b77","is-json-e38b77"];
      return Promise.all(
        names
