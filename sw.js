...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-bd8e0b","is-html-bd8e0b","is-jsdelivr-bd8e0b","is-gtm-bd8e0b","is-gravatar-bd8e0b","is-theme-bd8e0b","is-cdn-bd8e0b","is-json-bd8e0b"];
      return Promise.all(
        names
