...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-f5ce5c","is-html-f5ce5c","is-jsdelivr-f5ce5c","is-gtm-f5ce5c","is-gravatar-f5ce5c","is-theme-f5ce5c","is-cdn-f5ce5c","is-json-f5ce5c"];
      return Promise.all(
        names
