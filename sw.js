...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-cccc48","is-html-cccc48","is-jsdelivr-cccc48","is-gtm-cccc48","is-gravatar-cccc48","is-theme-cccc48","is-cdn-cccc48","is-json-cccc48"];
      return Promise.all(
        names
