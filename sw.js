...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-34789c","is-html-34789c","is-jsdelivr-34789c","is-gtm-34789c","is-gravatar-34789c","is-theme-34789c","is-cdn-34789c","is-json-34789c"];
      return Promise.all(
        names
