...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-93374a","is-html-93374a","is-jsdelivr-93374a","is-gtm-93374a","is-gravatar-93374a","is-theme-93374a","is-cdn-93374a","is-json-93374a"];
      return Promise.all(
        names
