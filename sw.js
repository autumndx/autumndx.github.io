...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-2782d2","is-html-2782d2","is-jsdelivr-2782d2","is-gtm-2782d2","is-gravatar-2782d2","is-theme-2782d2","is-cdn-2782d2","is-json-2782d2"];
      return Promise.all(
        names
