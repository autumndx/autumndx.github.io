...
function bot_ui_ini() {
    ...
    var sure = function () {
            ...
            botui.message.add({
                delay: 600,
                content: "![...](https://gitee.com/DxSummer/pic/raw/master/img/inside/talkphoto.png)"
            })
        },
        secondpart = function () {
            botui.message.add({
        ...
        thirdpart = function () {
            botui.message.add({
                delay: 1e3,
                content: "Dx是大侠的拼音，大侠在古代泛指通过自身力量帮助他人的对社会和他人做出贡献的，且具备超出一般人的能力、勇气、道德仁义，有大作为的人。"
            }).then(function () {
                botui.action.button({
                    delay: 1500,
                    action: [{
